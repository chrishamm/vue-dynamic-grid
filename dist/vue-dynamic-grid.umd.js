...
var itemKey = 1,
    itemsToAdd = []; // Get the requested size from an object or at least a deserialized fallback option
...
/* harmony default export */ var DynamicGridvue_type_script_lang_js_ = ({
  ...
  computed: {
    layout: {
      get: function get() {
        return this.responsive ? this.layouts[this.size] : this.layouts.md;
      },
  ...
  beforeMount: function beforeMount() {
    ...
    }, this); // Make sure this component becomes responsive. See Element-UI breakpoints for further information.
