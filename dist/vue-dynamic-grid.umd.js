(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueDynamicGrid"] = factory(require("vue"));
	else
		root["VueDynamicGrid"] = factory(root["Vue"]);
...
// load the styles
var content = __webpack_require__("95c4");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("e7f1241a", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicGrid_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("449f");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicGrid_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicGrid_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DynamicGrid_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./src/components/AutoSize.js
...
function resize(el, binding, vnode, inserted) {
  ...
  if (resizeWidth || resizeHeight) {
    var gridItem = vnode.componentInstance || vnode.context;
  ...
  if (inserted) {
    var _gridItem = vnode.componentInstance || vnode.context;
    ...
    while (_gridItem && _gridItem.$options._componentTag !== 'vue-grid-item') {
      _gridItem = _gridItem.$parent;
    }
    ...
    _gridItem.$on('resized', function () {
      return setTimeout(function () {
        return resize(el, binding, vnode, false);
      }, 0);
    });
  }
}
...
window.addEventListener('resize', function () {
  resizableElements.forEach(function (item) {
    return resize(item.el, item.binding, item.vnode);
  });
});
/* harmony default export */ var AutoSize = ({
  bind: function bind(el, binding, vnode) {
    return resizableElements.push({
      el: el,
      binding: binding,
      vnode: vnode
    });
  ...
  unbind: function unbind(el, binding, vnode) {
    return resizableElements = resizableElements.filter(function (item) {
      return item.vnode !== vnode;
    });
  },
  inserted: function inserted(el, binding, vnode) {
    return setTimeout(function () {
      return resize(el, binding, vnode, true);
    }, 100);
  },
...
/* harmony default export */ var DynamicGridvue_type_script_lang_js_ = ({
  name: 'DynamicGrid',
  components: {
    'vue-grid-layout': vue_grid_layout_common_default.a.GridLayout,
    'vue-grid-item': vue_grid_layout_common_default.a.GridItem
  },
  computed: {
    layout: {
      get: function get() {
        return this.responsive ? this.layouts[this.currentSize] : this.layouts.md;
      },
  ...
  methods: {
    addElement: function addElement(tagName, layouts, settings, childProps) {
      if (!this.isReady) {
        this.$nextTick(function () {
      ...
      breakpoints.forEach(function (size) {
        var descriptor = getDescriptor(layouts, size).slice();
    ...
    selectElement: function selectElement(item) {
      ...
      if (item == null) {
        ...
        var focusedItem = this.$el.querySelector(":focus");
    ...
    save: function save() {
      return this.gridItems.map(function (gridItem, index) {
        var child = gridItem.componentOptions.children[0];
        var item = {
    ...
    registerBreakpoint: function registerBreakpoint(condition, size) {
  ...
  render: function render(createElement) {
    ...
    itemsToAdd.forEach(function (item) {
      var component = createElement(item.tagName, item.childProps !== undefined ? {
        props: item.childProps
      } : {});
      var gridItem = createElement('grid-item', [component]);
      ...
      var el = createElement('vue-grid-item', {
        ...
        on: {
          click: function click(e) {
            el.context.removeElement(el.componentInstance);
          }
        },
        style: !this.editing ? {
          display: "none"
        } : {}
      }, ["x"]), gridItem.componentOptions.children]); // Load saved data on next tick

      if (!item.settingsLoaded) {
        this.$nextTick(function () {
          var instance = gridItem.componentOptions.children[0].componentInstance;

          if (!item.settingsLoaded && instance !== undefined) {
            var loadFn = instance.load;
...
// CONCATENATED MODULE: ./src/components/DynamicGrid.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_DynamicGridvue_type_script_lang_js_ = (DynamicGridvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/DynamicGrid.vue?vue&type=style&index=0&lang=css&
var DynamicGridvue_type_style_index_0_lang_css_ = __webpack_require__("c08d");
...
// CONCATENATED MODULE: ./src/components/DynamicGrid.vue
...
var component = normalizeComponent(
  components_DynamicGridvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
component.options.__file = "DynamicGrid.vue"
/* harmony default export */ var DynamicGrid = (component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"02ee7ab9-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DynamicGridItem.vue?vue&type=template&id=736aafe7&
var DynamicGridItemvue_type_template_id_736aafe7_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v("\n\tThis is just a dummy and is replaced by a vue-grid-item instance during rendering!\n\t"),_vm._t("default")],2)}
var DynamicGridItemvue_type_template_id_736aafe7_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/DynamicGridItem.vue?vue&type=template&id=736aafe7&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DynamicGridItem.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var DynamicGridItemvue_type_script_lang_js_ = ({
...
// CONCATENATED MODULE: ./src/components/DynamicGridItem.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_DynamicGridItemvue_type_script_lang_js_ = (DynamicGridItemvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/DynamicGridItem.vue
...
var DynamicGridItem_component = normalizeComponent(
  components_DynamicGridItemvue_type_script_lang_js_,
  DynamicGridItemvue_type_template_id_736aafe7_render,
  DynamicGridItemvue_type_template_id_736aafe7_staticRenderFns,
  false,
  null,
  null,
  null
...
DynamicGridItem_component.options.__file = "DynamicGridItem.vue"
/* harmony default export */ var DynamicGridItem = (DynamicGridItem_component.exports);
// CONCATENATED MODULE: ./src/components/index.js
...
var VueDynamicGrid = {
  ...
  DynamicGridItem: DynamicGridItem
};
external_commonjs_vue_commonjs2_vue_root_Vue_default.a.component('dynamic-grid', DynamicGrid);
external_commonjs_vue_commonjs2_vue_root_Vue_default.a.component('dynamic-grid-item', DynamicGridItem);
external_commonjs_vue_commonjs2_vue_root_Vue_default.a.directive('auto-size', AutoSize);
/* harmony default export */ var components = (VueDynamicGrid);

// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js
/* concated harmony reexport DynamicGrid */__webpack_require__.d(__webpack_exports__, "DynamicGrid", function() { return DynamicGrid; });
/* concated harmony reexport DynamicGridItem */__webpack_require__.d(__webpack_exports__, "DynamicGridItem", function() { return DynamicGridItem; });
/* concated harmony reexport AutoSize */__webpack_require__.d(__webpack_exports__, "AutoSize", function() { return AutoSize; });
...
//# sourceMappingURL=vue-dynamic-grid.umd.js.map